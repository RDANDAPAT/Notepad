  ...
  <div class="login-form">
    <form action="" method="POST">
      ...
      <div class="content">
        ...
        <div>REMEMBER ME: <input name="remember" type="checkbox" <?php //echo get_cookie('remember') ? 'checked="checked"' : ''; 
                                                                  ?> /></div>
        <a href="#" class="link">Forgot Your Password?</a>
      </div>
      <div class="action">
        <button id="signup" type="button" onclick="window.location.href='<?php echo base_url('register/Google_login'); ?>'"><img class="g_img" src="<?php echo base_url('assets/images/google.png'); ?>"> SignUp</button>
